...
QT_MOC_LITERAL(1, 13, 21), // "signalDockwidgetClose"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "MyDockWidget\0signalDockwidgetClose\0"
};
...
void MyDockWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyDockWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalDockwidgetClose(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyDockWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyDockWidget::signalDockwidgetClose)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyDockWidget::staticMetaObject = { {
    &QDockWidget::staticMetaObject,
    qt_meta_stringdata_MyDockWidget.data,
    qt_meta_data_MyDockWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void MyDockWidget::signalDockwidgetClose()
{
